...
namespace analizadorLexico
{
    ...
    class MiniCompilador
    {
        ...
        public void cargarMatriz()
        {
            ...
            String[] lineas = File.ReadAllLines(@"C:\Users\URIEL\Desktop\pruebax\AnalizadorSemantico-main\xs.lr", Encoding.Default);
        ...
        public void cargarReglas()
        {
            int delimitador = 9;
            char _dem = Convert.ToChar(delimitador);
            string[] lineas = File.ReadAllLines(@"C:\Users\URIEL\Desktop\pruebax\AnalizadorSemantico-main\rl.txt", Encoding.Default);
